...
<html>
  ...
  <body>
    <div class="page" style="background-color: skyblue">
      <!-- Main Navbar-->
      <header class="header">
            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <div class="navbar-header">
                <!-- Navbar Brand --><a href="#" class="navbar-brand">
                  <div class="brand-text brand-big"><span>Bookstore System</span></div>
                  <div class="brand-text brand-small">Bookstore System</div></a>
      ...
      <div class="page-content d-flex"> 
        <!-- Side Navbar -->
        <nav class="side-navbar" style="background-color: lightgrey">
          <!-- Sidebar Header-->
